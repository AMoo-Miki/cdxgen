...
it("parse conan data", () => {
  ...
  assert.deepStrictEqual(conanLockData.pkgList[0], {
    ...
    properties: [
      {
        name: "SrcFile",
        value: "./test/data/conan-v1-for-reference.lock",
      },
    ],
  });
  ...
  assert.deepStrictEqual(conanLockData.pkgList[0], {
    ...
    properties: [
      {
        name: "SrcFile",
        value: "./test/data/conan-v1-with-nested-deps.lock",
      },
    ],
  });
...
it("parse conan data where packages use custom user/channel", () => {
  ...
  assert.deepStrictEqual(conanLockData.pkgList[0], {
    ...
    properties: [
      {
        name: "SrcFile",
        value: "./test/data/conan.with_custom_pkg_user_channel.lock",
      },
    ],
  });
  assert.deepStrictEqual(conanLockData.pkgList[1], {
