...
it("parse gradle dependencies", async () => {
  ...
  assert.deepStrictEqual(parsedList.pkgList[0], {
    ...
    properties: [
      {
        name: "SrcFile",
        value: [["./test"]], // Array of arrays - direct dep with no config
      },
      {
  ...
  assert.deepStrictEqual(firstChain[0], "./test", "Chain should start with gradle file");
  ...
  // All chains should start with gradle file
  assert.ok(runnerSrcFile.value.every(chain => 
    Array.isArray(chain) && chain[0] === "./test/data"
  ), "All chains should start with gradle file");
  ...
  assert.deepStrictEqual(parsedList.pkgList[103], {
    ...
    properties: [
      {
        name: "SrcFile",
        value: [["./test/data", "releaseUnitTestRuntimeClasspath"]], // Array of arrays - single chain
      },
      {
    ...
    properties: [
      {
        name: "SrcFile",
        value: [
          // Direct from compileClasspath
          ["./test/data", "compileClasspath"],
          // Via spring-boot-starter-data-jpa in compileClasspath
          [
            "./test/data",
            "compileClasspath",
          ...
          // Direct from runtimeClasspath
          ["./test/data", "runtimeClasspath"],
          // Via spring-boot-starter-data-jpa in runtimeClasspath
          [
            "./test/data",
            "runtimeClasspath",
            "org.springframework.boot:spring-boot-starter-data-jpa@2.3.1.RELEASE",
          ...
          // Direct from testCompileClasspath
          ["./test/data", "testCompileClasspath"],
          // Via spring-boot-starter-data-jpa in testCompileClasspath
          [
            "./test/data",
          ...
          // Direct from testRuntimeClasspath
          ["./test/data", "testRuntimeClasspath"],
          // Via spring-boot-starter-data-jpa in testRuntimeClasspath
          [
            "./test/data",
